...
(function () {
  const IT = {
    ...
    'hl.krakow1': 'Una tassonomia scientifica da 110.000 concetti costruita con graph clustering, embedding e LLM.',
    'hl.krakow2': 'Classificazione automatica dei paper su larga scala con retrieval, reranking e validazione LLM.',
    ...
    'projects.paper': 'Leggi il paper (arXiv)',
    ...
    'pub.subtitle': 'Libri, saggi e paper di ricerca — liberi da leggere online o scaricare.',
    'pub.kicker': "Saggio sull'Intelligenza Artificiale",
    'pub.kicker.scale': 'Paper di Ricerca · Preprint arXiv',
    'pub.scale.subtitle': 'Estendere la taxonomy di OpenAlex con 114.000 Concept scientifici a grana fine.',
    'pub.scaledesc': "Scritto insieme a Feichi Lu, Oliver Grun, Mariia Eremina e Andrea Perlato presso MDPI Data Intelligence. SCALE estende la taxonomy di OpenAlex con un nuovo quinto livello di 113.892 Concept scientifici a grana fine, costruiti combinando embedding SPECTER2, classificazione della granularità basata su LLM e clustering di grafi con l'algoritmo di Leiden su quasi tre milioni di parole chiave d'autore MDPI. La taxonomy risultante alimenta Atlantis e il Taxonomy Explorer, ed è già in produzione per taggare il corpus MDPI di quasi due milioni di articoli.",
    'pub.tag.paper': 'Paper di Ricerca',
    'pub.arxiv': 'Vedi su arXiv',
    'pub.pages': 'pagine',
    'pub.lang': 'Italiano',
    'pub.lang.en': 'Inglese',
    ...
    'talks.euroscipy1': 'Come trasformare milioni di keyword rumorose degli autori in una tassonomia a cinque livelli con oltre 110.000 concetti, con embedding SPECTER2, graph clustering Leiden e LLM in punti decisionali mirati.',
    'talks.euroscipy2': 'Tagging di milioni di paper scientifici su una tassonomia da 110.000 concetti con retrieval vettoriale, reranking cross-encoder e validazione LLM selettiva.',
